...
@section('login')
    <div class="login">
        ...
        <form class="login__form" action="{{ route('login') }}" method="POST" autocomplete="off">
            @csrf
            ...
            <div class="login__not-account">
                <span>У вас нет есть аккаунта?</span>
                <a class="login__not-account_link" href="{{ route('register') }}">
                    Регистрация
                </a>
            </div>
        </form>
